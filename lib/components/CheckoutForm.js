...
export default function CheckoutForm({ totalCost, localizedText, items, shoppingCart, onSuccess, onFailure, locale }) {
		...
		<form onSubmit={formik.handleSubmit}>
			...
			`}>
				<div className={totalCostContainer}>
					{`${localizedText.totalCost}: ${currencyFormat(totalCost, locale.language)}`}
				</div>
				<div className={css`
					display: flex;
					flex-direction: column;
