...
export default function ConfirmationForm({ localizedText, placeOrder, errorState, isFetching}) {

	const [schemaState, setSchemaState] = useState()

	const [buttonDisabled, setButtonDisabled] = useState(false)

	const [formikErrorState, setFormikErrorState] = useState(null)

	useEffect(() => {
		registerFormik.resetForm()
		setSchemaState(yup.object({
		  email: yup
		    .string()
							...
							`}>
								...
								<div>
									<CustomTextField
										...
										onChange={(e) => {
											if (formikErrorState !== null) {
												setFormikErrorState(null)
											}
